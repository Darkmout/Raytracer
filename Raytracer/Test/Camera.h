...
public:
	...
	__host__ __device__ void Move(Vec3 MoveLocal)
	{
		...
		Vec3 v0v2 = Plan.v2 - Plan.v0;
		Vec3 MoveGlobal = Vec3(
			Plan.Normal.x * MoveLocal.x  + v0v2.x * MoveLocal.y,
			Plan.Normal.y * MoveLocal.x  + v0v2.y * MoveLocal.y,
			Plan.Normal.z * MoveLocal.x  + v0v2.z * MoveLocal.y + MoveLocal.z);
